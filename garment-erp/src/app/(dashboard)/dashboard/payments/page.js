  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <div className="card text-center"><div className="text-xs text-gray-500">Total Due</div><div className="text-xl font-bold text-red-600">${totalDue.toLocaleString(undefined, { minimumFractionDigits: 2 })}</div></div>
        <div className="card text-center"><div className="text-xs text-gray-500">Overdue Amount</div><div className="text-xl font-bold text-red-700">${totalOverdue.toLocaleString(undefined, { minimumFractionDigits: 2 })}</div></div>
      </div>
          ...
          <tbody>
            {outstanding.map(inv => (
              <tr key={inv.id}>
                ...
                <td>{inv.currency} {parseFloat(inv.totalAmount).toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
                <td className="text-green-600">{inv.currency} {parseFloat(inv.amountPaid).toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
                <td className="font-bold text-red-600">{inv.currency} {parseFloat(inv.amountDue).toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
